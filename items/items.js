fetch('starter.json') //fetch data
    ...
    .then(data => {
        ...
        $(document).ready(function() {
            $("#starterctn .item").click(function() {
...
fetch('epic.json')
    ...
    .then(data => {
        ...
        $(document).ready(function() {
            ...
            $("#epicctn .item").click(function() {
                $(".item").removeClass("item-clicked");
                $(this).addClass("item-clicked");

                const itemdata = $(this).data('epic');
                const clickeditem = data[itemdata];
...
fetch('legendary.json')
    ...
    .then(data => {
        ...
        $(document).ready(function() {
            $("#legendaryctn .item").click(function() {
                
                $(".item").removeClass("item-clicked");
                $(this).addClass("item-clicked");

                const itemdata = $(this).data('legendary');
                const clickeditem = data[itemdata];
...
fetch('mythic.json')
    ...
    .then(data => {
        ...
        $(document).ready(function() {
            $("#mythicctn .item").click(function() {
                
                $(".item").removeClass("item-clicked");
                $(this).addClass("item-clicked");

                const itemdata = $(this).data('mythic');
                const clickeditem = data[itemdata];
